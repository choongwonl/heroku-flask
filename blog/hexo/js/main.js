(function ($) {
    ...
    var elements = document.querySelectorAll('div.highlight-container');
      for(var i = 0; i < elements.length; i++){
         var inside_element = elements[i].querySelector('figure.highlight')
        elements[i].setAttribute('data-code',  inside_element.classList[1]);
      };
